...
#LEDs
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { LED3 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { LED2 }]; #IO_L16P_T2_CSI_B_14 Sch=led[12]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { LED1 }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
...
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports {p_data[1]}]
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports {p_data[3]}]
set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports {p_data[5]}]
set_property -dict {PACKAGE_PIN E7 IOSTANDARD LVCMOS33} [get_ports {PWDN[0]}]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports {p_data[0]}]
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {p_data[2]}]
set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS33} [get_ports {p_data[4]}]


##Pmod Header JD

set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports {p_data[7]}]
...
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports vsync]
set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports SIOC_oe]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports {p_data[6]}]
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports XCLK]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports href]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports SIOD_oe]
...
#set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports UART_0_RX]
#set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports UART_0_TX]
